...
FilesArray=("vertex"  "build"  "actcor"  "convex" "ctransf" "fluids" "frendly" "meemum" "pspts" "pssect" "pstable" "psvdraw" "pt2curv" "werami" "MC_fit" "perplexwrap"))
...
products = [
    ...
    LibraryProduct("libperplexwrap", :libperplexwrap),
]
